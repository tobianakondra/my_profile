  ...
  return (
    <form onSubmit={handleSubmit} className="relative p-6 lg:p-8 rounded-2xl bg-card border border-border">
      ...
      <Textarea
        ...
        required
        className="h-[140px] bg-slate-800/50 border-slate-600 border text-foreground placeholder:text-muted-fg/50 focus:border-accent focus:ring-0 rounded-xl resize-none transition-all duration-300 mb-4"
      />
